...
public interface IFlightController extends IController<IntentEntity, MvwLParamEntity, StkResultEntity> {
    void showFlightActivity(String resultStr, String semantic);
}