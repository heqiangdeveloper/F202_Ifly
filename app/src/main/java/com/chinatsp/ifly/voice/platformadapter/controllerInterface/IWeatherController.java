...
public interface IWeatherController extends IController<IntentEntity, MvwLParamEntity, StkResultEntity> {
    void showWeatherActivity(String resultStr, String semantic);
}
